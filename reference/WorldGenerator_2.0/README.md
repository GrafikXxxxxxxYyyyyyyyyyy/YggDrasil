...
**Единый всеобъемлющий канон проекта:** **[CANON.md](CANON.md)** — референс архитектуры, которому необходимо следовать; канон допускает уточнение и расширение. Все документы в этом каталоге входят в канон или ссылаются на него.

**Свежий старт:** полный рефакторинг и расширение концепции World Generator. Старый каталог `WorldGenerator` сохранён как архив; здесь — целостная модель с нуля.

---

## Зачем 2.0

- **WorldGenerator_2.0** — один канон: один цикл мира (Философ → Автор → Среда → Архитектор → Творец), идеальные задачи этапов ([Scheme.md](Scheme.md) §1.1), state из пяти блоков, агентные системы и гибкость использования ([AGENT_SYSTEMS_SUPPORT.md](AGENT_SYSTEMS_SUPPORT.md)), расширение «Вселенная» для сообщества ([EXPANSION_UNIVERSE_GRAPH_OF_WORLDS.md](EXPANSION_UNIVERSE_GRAPH_OF_WORLDS.md)). Операционная схема — **[Scheme.md](Scheme.md)**. Философия — **[Philosophy.md](Philosophy.md)**.
...
| Документ | Назначение |
|----------|------------|
| **[CANON.md](CANON.md)** | **Единый всеобъемлющий канон** — состав канона, ключевые принципы, использование; входная точка для архитектуры. |
...
| **[AGENT_SYSTEMS_SUPPORT.md](AGENT_SYSTEMS_SUPPORT.md)** | **Поддержка агентных систем:** полная и глубоко встроенная — агент как блок/узел (состояние, tool_calls/tool_results), роль Agent и узлы-инструменты, режим agent_loop в графе, граф-агент как узел пайплайна/этапа, мир с агентными этапами. |
| **[TRAINING_REUSE_AND_API_SCENARIOS.md](TRAINING_REUSE_AND_API_SCENARIOS.md)** | **Обучение при повторном использовании и при API:** коллизии (оптимизатор, градиенты), LoRA при общем блоке, обучение мира с API-узлами (промпт-адаптеры), сценарии и обходы. |
...
| **[HYPERGRAPH_AND_HYPERLINKS.md](HYPERGRAPH_AND_HYPERLINKS.md)** | **Гиперграф как движок:** вся архитектура устроена как **гиперграф**; **крупномасштабные гиперссылки** для связывания контекстов и взаимодействия. |
| **[END_WORLDS.md](END_WORLDS.md)** | **End Worlds (миры-завершения):** фиксированные, неизменяемые миры; к ним можно привязываться и с ними взаимодействовать; объектный мир обогащает контекст и истории, End World не меняется (пример: книга). |
| **[EXPANSION_UNIVERSE_GRAPH_OF_WORLDS.md](EXPANSION_UNIVERSE_GRAPH_OF_WORLDS.md)** | **Расширение выше мира:** уровень **Вселенная (Universe)** — гиперграф миров; взаимодействие между мирами и сущностями; **этап Вселенной для сообщества**; **End Worlds**; кросс-мировое влияние; сопоставление с мифологией Иггдрасиля. |
