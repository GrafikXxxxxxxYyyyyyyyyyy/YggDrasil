...
**Обучение при повторном использовании моделей и при API:** коллизии (дублирование параметров в оптимизаторе, градиенты с нескольких мест), решения и обходы, LoRA при общем блоке, обучение мира с API-узлами — см. [TRAINING_REUSE_AND_API_SCENARIOS.md](TRAINING_REUSE_AND_API_SCENARIOS.md).
