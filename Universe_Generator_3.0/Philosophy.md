...
**Устойчивость документа.** Данный текст философии призван быть **якорем**: реализации, канон и конкретные форматы могут эволюционировать, но принципы (два начала, синтез, гиперграф, Lego, граница, кастомизируемость без изменений движка и т.д.) остаются **стабильными**. Изменения в Philosophy — **редкие** и **обоснованные**; они касаются уточнения или развития единой мысли, а не подстройки под частные случаи. Так проект сохраняет одну мысль во времени: канон и код могут меняться в рамках философии, сама философия — устойчивый ориентир, относительно которого определяется «соответствие» проекту.
