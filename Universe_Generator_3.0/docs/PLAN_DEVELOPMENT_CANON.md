...
**Назначение:** пошаговый план создания нового канона — от фиксированной философии до полной технической документации и точки входа в реализацию. Философия считается **закрытой** и **не меняется**; она — якорь и «библия» нового проектирования.

**Связь:** [../Scheme.md](../Scheme.md) — схема и новый канон; [../Philosophy.md](../Philosophy.md) — якорь.
...
- **Philosophy.md** — полностью готова, не правим, используем как абсолютный ориентир.
...
- Философия закрыта и зафиксирована.
- Никаких правок Philosophy при разработке канона; при противоречии меняем схему и документы, а не философию.
