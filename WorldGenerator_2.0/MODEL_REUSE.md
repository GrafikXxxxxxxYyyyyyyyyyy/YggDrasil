...
| [AGENT_SYSTEMS_SUPPORT.md](AGENT_SYSTEMS_SUPPORT.md) | Агентные системы: агент и инструменты могут использовать один и тот же LLM/модель по ref; состояние агента в state_dict блока. |
