...
Обучение, LoRA и повторное использование моделей при работе через API и при общих весах описаны в [TRAINING_REUSE_AND_API_SCENARIOS.md](TRAINING_REUSE_AND_API_SCENARIOS.md). Агентные системы (агент с LLM по API и инструментами) — в [AGENT_SYSTEMS_SUPPORT.md](AGENT_SYSTEMS_SUPPORT.md).
