#!/usr/bin/env python3
"""
Compare Diffusers vs YggDrasil for image models: SD 1.5, SDXL, SD3.
...
def _run_diffusers(cfg, prompt, num_steps, guidance_scale, width, height, seed, device):
    ...
    pipe_cls = pipe_map[cfg["diffusers_pipeline"]]
...
def main():
    ...
    parser.add_argument("--model", choices=list(_MODELS), default="sd15", help="sd15, sdxl, sd3")
    ...
    print("Done. Compare: %s (Diffusers) vs %s (YggDrasil)" % (out_dir / "diffusers.png", out_dir / "yggdrasil.png"))
    return 0
