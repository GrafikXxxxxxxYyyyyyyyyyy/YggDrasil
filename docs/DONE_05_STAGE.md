...
**Канон проекта:** [CANON.md](../WorldGenerator_2.0/CANON.md). **Канон:** [TODO_05_STAGE.md](../WorldGenerator_2.0/TODO_05_STAGE.md), [Stage_Level.md](../WorldGenerator_2.0/Stage_Level.md), [Scheme.md](../WorldGenerator_2.0/Scheme.md) (§1.1 идеальные задачи этапов).
