...
- **Уровень над фундаментом:** абстрактные узлы-задачи (Backbone, Injector, Conjector, Inner Module, Outer Module, Helper, Converter) — двойное наследование Block и Node; документ по этому уровню — следующий в иерархии документации.
