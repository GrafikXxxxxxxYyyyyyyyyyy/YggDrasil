...
| **[docs/](docs/)** | Детальные документы по уровням: [01_FOUNDATION.md](docs/01_FOUNDATION.md) (фундамент), [02_ABSTRACT_TASK_NODES.md](docs/02_ABSTRACT_TASK_NODES.md) (абстрактные узлы-задачи) и далее по мере заполнения. |
